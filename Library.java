...
public class Library {
	...
	Image libTut = new Image(getClass().getResourceAsStream("libTut.png"));
	...
	public Library(){
		...
		numPages = read.getNumPages(); //TODO remove this line
	}
	...
	public VBox makeLibrary(){
		...
		VBox vlib = new VBox();
		vlib.getChildren().addAll(new ImageView(libTut),libLayout);
		return vlib;
	}
	...
	public VBox makeBox(NodeList nL, int selectedPage){
		...
		for(int i=0; i<nL.getLength(); i++){
			...
			if(currentPage == selectedPage){ //TODO ADD a break statement of some sort
